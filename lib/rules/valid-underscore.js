...
module.exports = {
    ...
    create: function (context) {
        ...
        const allowParent = options.allowParent ? options.allowParent : [];
        ...
        /**
         * Check if identifier of parent is present inside the allowed option
         * @param {string} identifier name of the node
         * @returns {boolean} true if its is present
         * @private
         */
        function isAllowedParent (identifier) {
            return allowParent.some(ident => ident === identifier);
        }
        ...
        function checkForTrailingUnderscoreInMemberExpression (node) {
            ...
            const identifierParent = getName(node.object);
            ...
            if (typeof identifier !== 'undefined' && hasTrailingUnderscore(identifier)
                ...
                && (!identifierParent || !isAllowedParent(identifierParent))) {
                context.report({
                    node: node,
                    messageId: 'unexpectedUnderscore',
                    data: {
